...
export default function ArtisanalJourney() {
  return (
    <section className="py-16 bg-primary-container/20 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center px-margin-mobile relative z-10">
        <Reveal>
          ...
          <p className="font-serif italic text-body-lg text-on-surface-variant mb-6 leading-loose">
          ...
          <Link
            href="/#about"
            className="btn-pill btn-pill-primary shadow-lift active:scale-95 transition-all min-h-[48px]"
          >
            LEARN OUR STORY
          </Link>
        </Reveal>
